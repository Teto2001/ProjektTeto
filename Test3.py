...
# Beispielaufruf
# hier sind 12
csv_path = r"\\imeso-srv\User\Yolande\Projekt\Probedaten.csv" # Pfad zur hochgeladenen CSV-Datei
output_fr = "Probedaten_fr.csv"  # Pfad für die französische Übersetzung
output_en = "Probedaten_en.csv"  # Pfad für die englische Übersetzung
