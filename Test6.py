...
# Beispielaufruf
# Hier sind 200
csv_path = r"\\imeso-srv\User\Yolande\Projekt\TeilDaten200.csv" # Pfad zur hochgeladenen CSV-Datei
output_fr = "TeilDaten200_fr.csv"  # Pfad für die französische Übersetzung
output_en = "TeilDaten200_en.csv"  # Pfad für die englische Übersetzung
