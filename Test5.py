...
# Beispielaufruf
# Hier sind 100
csv_path = r"\\imeso-srv\User\Yolande\Projekt\TeilDaten100.csv"  # Pfad zur hochgeladenen CSV-Datei
output_fr = "TeilDaten100_fr.csv"  # Pfad für die französische Übersetzung
output_en = "TeilDaten100_en.csv"  # Pfad für die englische Übersetzung
